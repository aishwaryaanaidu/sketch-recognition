...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if(exif_imagetype($_FILES["fileUpload"]["tmp_name"])){ // Check if the file is actually an image.
                ...
                if(move_uploaded_file($_FILES["fileUpload"]["tmp_name"], $filepath)){
                  $result = exec("python input_query.py C:\xampp\htdocs\sketch\knn\input_query.py");
...
<nav class="navbar navbar-default navbar-light  navbar-fixed-top" style="background-color: #f7d9a0;">
        ...
        <center> <a href="../index.php"><h4 style="color:red;">Sketch Recognition for Image Classification and Retrieval</h4></a> </center>
